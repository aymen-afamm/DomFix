          ...
          slivers: [
            ...
            SliverToBoxAdapter(child: Padding(
              ...
              child: SizedBox(height: 210, child: ListView.separated(
                ...
                itemCount: _featured.length, separatorBuilder: (_, __) => const SizedBox(width: 12),
                itemBuilder: (_, i) => _FeaturedCard(tech: _featured[i]),
              )),
            )),
            // Nearby
            SliverToBoxAdapter(child: Padding(
            ...
            SliverPadding(
              ...
              sliver: SliverList(delegate: SliverChildBuilderDelegate(
                (_, i) => Padding(padding: const EdgeInsets.only(bottom: 12), child: _NearbyCard(tech: _nearby[i])),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        SizedBox(height: 140, child: Stack(fit: StackFit.expand, children: [
          Image.network(tech.imageUrl, fit: BoxFit.cover,
            errorBuilder: (_, __, ___) => Container(color: AppColors.surfaceContainerHigh, child: Icon(Icons.engineering_outlined, color: AppColors.onSurfaceVariant, size: 40))),
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ClipRRect(borderRadius: BorderRadius.circular(10),
          child: Image.network(tech.imageUrl, width: 72, height: 72, fit: BoxFit.cover,
            errorBuilder: (_, __, ___) => Container(width: 72, height: 72, color: AppColors.surfaceContainerHigh, child: Icon(Icons.person_outline, color: AppColors.onSurfaceVariant)))),
