    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            message.isUser ? 'YOU • ${message.timestamp}' : 'AI ASSISTANT • ${message.timestamp}',
            style: GoogleFonts.inter(
              fontSize: 9,
              fontWeight: FontWeight.w600,
              letterSpacing: 1,
              ...
              return Row(
                children: List.generate(3, (index) {
                  ...
                  return Container(
                    ...
                    height: 6,
                    decoration: BoxDecoration(
                      color: AppColors.primaryContainer.withValues(alpha: 0.3 + opacity * 0.7),
                      shape: BoxShape.circle,
                    ),
                  );
                }),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(Icons.psychology, 'AI CHAT', true, () {}),
          _buildNavItem(Icons.engineering_outlined, 'PROS', false, () {}),
          _buildNavItem(Icons.settings_remote_outlined, 'CONTROL', false, () {}),
