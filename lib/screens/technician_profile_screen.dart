...
class ReviewItem {
  final String reviewerName, comment, timeAgo;
  ...
  Widget _buildStats(TechnicianProfile p) {
    return Row(
      children: [
        ...
        Expanded(
          child: _StatCard(
            value: p.experienceYears > 0 ? '${p.experienceYears}yr' : '—',
            label: 'Experience',
          ),
        ),
        const SizedBox(width: 8),
        Expanded(
          child: _StatCard(value: p.replyTime, label: 'Reply'),
        ),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Row(
            children: ['Standard', 'Urgent', 'Emergency']
                .map(
                  (u) => Padding(
